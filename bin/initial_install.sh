...
nix --extra-experimental-features "nix-command flakes" run github:nix-community/disko -- --mode disko /tmp/copycat/${PHASE}/disko.git '"/dev/'${DISK_DEV}'"'
...
echo "}" >> _origin-version.nix
#sed -i "s/"Have you read the  _origin-version.nix
